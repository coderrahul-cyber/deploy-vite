  ...
  return info ? (
    ...
    <div data-scroll-container ref={containerRef} style={{
      ...
      <div className="poster relative px-3 py-0  hover:shadow-2xl shadow-zinc-200/60 mt-24 h-[20vmax] w-[100%]  overflow-x-hidden overflow-y-scroll flex">
        ...
        <p className='param'><span className='text-sm  mr-1 uppercase font-semibold '>Status:</span>{info.details.status } ({info.details.release_date || "N/A"})</p>
        <p className='param'><span className='text-sm mr-1 uppercase font-semibold'>Runtime:</span>{(info.details.runtime / 60).toFixed(1) + `hr` || "N/A"}</p>
