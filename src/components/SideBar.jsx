  ...
  return (
    <div className='w-[20%] flex flex-col select-none  h-full border-r-[1px] p-3 rounded-xl   border-zinc-400 '>
        ...
        <nav className='flex flex-col gap-5   border-b-[1px] pb-10 rounded-md  text-lg'>
            ...
            <Link to="/trending" className='navv duration-500 '>
            <i className="ri-fire-fill mr-2"></i>Trending</Link>
            <Link to="/popular" className='navv duration-500'><i className="ri-bard-line mr-2"></i>Popular</Link> 
            <Link to="/movies" className='navv duration-500 '><i className="ri-movie-2-line mr-2"></i>Movies</Link>
            <Link to="/tv-show" className='navv duration-500'><i className="ri-slideshow-view mr-2"></i>tv Shows</Link>
            <Link to="/people" className='navv duration-500 '><i className="ri-team-fill mr-2"></i>People</Link>
        </nav>
