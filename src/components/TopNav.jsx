...
function TopNav() {
    ...
    return (
        <div className='w-full  items-center sm:px-3 py-4  sm:justify-center justify-center  flex  gap-5 relative '>
            ...
            <div className="  z-50  absolute sm:w-[50%] w-[80%]  flex flex-col gap-3  mt-4  sm:max-h-72 h-60  top-[90%]  overflow-auto ">

           {search.map((item ,index)=>(
             <Link to={`/deploy-vite/${item.media_type}/${item.id}`} key={index} className='flex border-y-[1px] mx-2 bg-zinc-400   peer/h  py-2 hover:shadow-md transition-all ease-in hover:shadow-zinc-400 border-zinc-300 rounded-xl  px-2  items-center gap-4 peer/l'>
